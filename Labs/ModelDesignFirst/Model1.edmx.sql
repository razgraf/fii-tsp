...
-- --------------------------------------------------
-- Date Created: 03/09/2020 22:48:36
-- Generated from EDMX file: E:\GITHUB\fii-work\3-TSPDOTNET\ModelDesignFirst_L2\Model1.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[spt_values]', 'U') IS NOT NULL
