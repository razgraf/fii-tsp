    ...
    class Program
    {
        ...
        static void TestOneToMany()    
        {
            ...
            using (ModelOneToManyContainer context =  new ModelOneToManyContainer())  
            {
                ...
                {
                    Name = "Customer 1",  City = "Iasi" 
                }; 
                Order o1 = new Order() 
                { TotalValue = 200,  Date = DateTime.Now, Customer = c 
                }; 
                Order o2 = new Order() {
                    TotalValue = 300,  Date = DateTime.Now, Customer = c
                };                 
        ...
        static void TestPerson()
        {
            using (Model1Container context = new Model1Container())
            {
                ...
                Person p = new Person() { FirstName = "Julie", LastName = "Andrew", MiddleName = "T", PhoneNumber = "1234567890" };
